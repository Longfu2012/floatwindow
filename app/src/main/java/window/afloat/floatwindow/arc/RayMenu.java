...
public class RayMenu extends RelativeLayout {
	...
	private void init(Context context) {
		...
		View view = li.inflate(R.layout.ray_menu, this);

		mRayLayout = (RayLayout) view.findViewById(R.id.item_layout);

		final ViewGroup controlLayout = (ViewGroup) view.findViewById(R.id.control_layout);
		...
		mHintView = (ImageView) view.findViewById(R.id.control_hint);
	}
